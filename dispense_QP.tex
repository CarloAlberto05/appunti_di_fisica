% ==========================================
% MAIN.TEX - PREAMBOLO OTTIMIZZATO PER ECCELLENZA TIPOGRAFICA
% ==========================================
\documentclass[
    % Rimosso a4paper per evitare conflitti con la geometria B5
    11pt,
    twoside,
    openright,
    numbers=noenddot, 
...
\usepackage{amsmath} 
\usepackage{amsthm}  % <--- AGGIUNTO: Fondamentale per thmtools
...
\newtcolorbox{concettochiave}[2][]{
    ...
    #1                        % Argomento opzionale per chiavi extra (es. nobreak)
}
...
% Box Testo Problema (Completamente automatizzato per l'indice)
\newtcolorbox{problemabox}[1]{
    ...
    fonttitle=\bfseries\sffamily,
    % Avanzamento automatico del contatore e inserimento in ToC
...
% Inclusione capitoli
\include{capitoli/cap_1}
\include{capitoli/cap_2}
\include{capitoli/cap_3}
\include{capitoli/cap_4}
\include{capitoli/cap_5}
\include{capitoli/cap_6}
\include{capitoli/cap_7}
\include{capitoli/cap_8}
\include{capitoli/cap_9}
